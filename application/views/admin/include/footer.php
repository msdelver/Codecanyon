  ...
  Highcharts.chart('incomeChart', {
      ...
      plotOptions: {
          series: {
              ...
              dataLabels: {
                  enabled: true,
                  format: '<?php if($this->business->symbol_direction == 'left'){echo html_escape($currency);} ?> {point.y:.2f} <?php if($this->business->symbol_direction == 'right'){echo html_escape($currency);} ?>'
              }
          }
      },
      ...
      tooltip: {
          ...
          pointFormat: '<span style="color:{point.color}">{point.name}</span> <b><?php if($this->business->symbol_direction == 'left'){echo html_escape($currency);} ?> {point.y:.2f} <?php if($this->business->symbol_direction == 'right'){echo html_escape($currency);} ?></b><br/>'
      },
  ...
  Highcharts.chart('adminIncomeChart', {
      ...
      plotOptions: {
          series: {
              ...
              dataLabels: {
                  enabled: true,
                  format: '<?php if(settings()->symbol_direction == 'left'){echo html_escape($currency);} ?>{point.y:.2f}<?php if(settings()->symbol_direction == 'right'){echo html_escape($currency);} ?>'
              }
          }
      },
      ...
      tooltip: {
          headerFormat: '<span style="font-size:11px">{series.name}</span><br>',
          pointFormat: '<span style="color:{point.color}">{point.name}</span> <b><?php if(settings()->symbol_direction == 'left'){echo html_escape($currency);} ?> {point.y:.2f} <?php if(settings()->symbol_direction == 'right'){echo html_escape($currency);} ?></b><br/>'
      },
