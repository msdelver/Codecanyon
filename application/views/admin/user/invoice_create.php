<div class="content-wrapper">
  ...
  <!-- Main content -->
  <section class="content <?php if (strlen(settings()->ind_code) == 40){echo "hide";} ?>">
    <div class="container">
                                                    ...
                                                    <div class="main-inv-product">
                                                        <div class="inv-product br-10 dshadow">
                                                            <div class="form-group has-search">
                                                                ...
                                                                <input type="text" class="form-control search_product" placeholder="<?php echo trans('type-product') ?>">
                                                            </div>
